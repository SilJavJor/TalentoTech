...
def mostrar_ayuda_menu(opcion_ingresada):
    #print(f"\n Ayuda: {opciones_menu[int(opcion_ingresada)][3]}\n")
    print(f"\n Ayuda: {opciones_menu[int(opcion_ingresada)][2]}\n")
...
def mostrar_menu(opcion_ingresada):
    ...
    while (indice < len(opciones_menu)):
        ...
        if (opciones_menu[indice][0] == int(opcion_ingresada)):

            print(f"> {opciones_menu[indice][1]}")
    ...
    mostrar_ayuda_menu(opcion_ingresada)
