...
def main():
    ...
    while True:
        ...
        elif key.isdigit():  # Verificar si se presionó un número
            opcion_seleccionada = int(key) - 1  # Convertir el carácter a número y ajustar para el índice
            if 0 <= opcion_seleccionada < len(menu_options):
                manejar_opcion(opcion_seleccionada)  # Manejar la opción seleccionada
        elif key == 'q':
