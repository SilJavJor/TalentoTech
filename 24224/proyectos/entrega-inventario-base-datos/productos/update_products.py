...
# Importa desde datos
from gestor_base_datos import actualiza_productos


# Actualizacion de la Cantidad
def actualiza_producto(producto):
    ...
    producto_actualizado_existosamente = actualiza_productos(producto[0], cantidad = cantidad)

    #
    if (producto_actualizado_existosamente):
...
def mostrar_titulo_actualizacion_cantidad():
    ...
    print(f"{Style.BRIGHT}{Fore.CYAN}             Actualizando Productos              \n")
    mostrar_linea_separacion()
